...
- **Version:** 0.5.3-insiders (see HTML comment above — this value is stamped during install/upgrade). Include it as `Squad v0.5.3-insiders` in your first response of each session (e.g., in the acknowledgment or greeting).
